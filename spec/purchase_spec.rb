...
describe Purchase do
  describe '#initialize' do
    it 'should initialize new instance of Purchase' do
      test_purchase = Purchase.new({'id' => 3, 'description' => 'burger', 'amount' => '$5.00', 'date' => '2003-04-12'})
    ...
    it 'returns that values of the instance variables' do
      ...
      test_purchase.date.should eq '2003-04-12'
  ...
  describe 'create' do
    it 'Saves a new instance of Purchase' do
      test_purchase = Purchase.create({'id' => 3, 'description' => 'burger', 'amount' => '$5.00', 'date' => '2003-04-12'})
  ...
  describe '#==' do
    it 'recognizes that two instances are equal if their values are the same' do
      test_purchase1 = Purchase.create({'description' => 'burger', 'amount' => '$5.00', 'date' => '2003-04-12'})
      test_purchase2 = Purchase.create({'description' => 'burger', 'amount' => '$5.00', 'date' => '2003-04-12'})
